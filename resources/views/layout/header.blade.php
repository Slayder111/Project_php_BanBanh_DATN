<div class="header-top">
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> Hà Đông, Hà Nội</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 0325788889</a></li>
                    </ul>
                </div>
        ...
        <div class="header-body">
            <div class="container beta-relative">
                <div class="pull-left">
                    <a href="{{url('trangchu')}}" id="logo"><img src="frontend/assets/dest/images/logo-cake.png" width="200px" alt=""></a>
                </div>
